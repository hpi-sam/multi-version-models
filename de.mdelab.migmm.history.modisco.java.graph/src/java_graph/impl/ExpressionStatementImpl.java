 ...
 * </p>
 * <ul>
 *   <li>{@link java_graph.impl.ExpressionStatementImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExpressionStatementImpl extends StatementImpl implements ExpressionStatement {
	...
	protected EClass eStaticClass() {
		return Java_graphPackage.eINSTANCE.getExpressionStatement();
	}
	...
	public EList<Expression> getExpression() {
		if (expression == null) {
			expression = new EObjectResolvingEList<Expression>(Expression.class, this, Java_graphPackage.EXPRESSION_STATEMENT__EXPRESSION);
		}
		return expression;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Java_graphPackage.EXPRESSION_STATEMENT__EXPRESSION:
