 ...
 * </p>
 * <ul>
 *   <li>{@link java_graph.impl.BreakStatementImpl#getLabel <em>Label</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BreakStatementImpl extends StatementImpl implements BreakStatement {
	...
	protected EClass eStaticClass() {
		return Java_graphPackage.eINSTANCE.getBreakStatement();
	}
	...
	public EList<LabeledStatement> getLabel() {
		if (label == null) {
			label = new EObjectWithInverseResolvingEList.ManyInverse<LabeledStatement>(LabeledStatement.class, this, Java_graphPackage.BREAK_STATEMENT__LABEL, Java_graphPackage.LABELED_STATEMENT__USAGES_IN_BREAK_STATEMENTS);
		}
		return label;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Java_graphPackage.BREAK_STATEMENT__LABEL:
