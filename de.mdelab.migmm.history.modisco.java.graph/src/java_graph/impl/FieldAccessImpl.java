 ...
 * </p>
 * <ul>
 *   <li>{@link java_graph.impl.FieldAccessImpl#getField <em>Field</em>}</li>
 *   <li>{@link java_graph.impl.FieldAccessImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FieldAccessImpl extends ExpressionImpl implements FieldAccess {
	...
	protected EClass eStaticClass() {
		return Java_graphPackage.eINSTANCE.getFieldAccess();
	}
	...
	public EList<SingleVariableAccess> getField() {
		if (field == null) {
			field = new EObjectResolvingEList<SingleVariableAccess>(SingleVariableAccess.class, this, Java_graphPackage.FIELD_ACCESS__FIELD);
		}
		return field;
	}
	...
	public EList<Expression> getExpression() {
		if (expression == null) {
			expression = new EObjectResolvingEList<Expression>(Expression.class, this, Java_graphPackage.FIELD_ACCESS__EXPRESSION);
		}
		return expression;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Java_graphPackage.FIELD_ACCESS__FIELD:
				return getField();
			case Java_graphPackage.FIELD_ACCESS__EXPRESSION:
