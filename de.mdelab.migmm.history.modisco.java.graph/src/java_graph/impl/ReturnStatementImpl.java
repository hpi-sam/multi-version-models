 ...
 * </p>
 * <ul>
 *   <li>{@link java_graph.impl.ReturnStatementImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReturnStatementImpl extends StatementImpl implements ReturnStatement {
	...
	protected EClass eStaticClass() {
		return Java_graphPackage.eINSTANCE.getReturnStatement();
	}
	...
	public EList<Expression> getExpression() {
		if (expression == null) {
			expression = new EObjectResolvingEList<Expression>(Expression.class, this, Java_graphPackage.RETURN_STATEMENT__EXPRESSION);
		}
		return expression;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Java_graphPackage.RETURN_STATEMENT__EXPRESSION:
