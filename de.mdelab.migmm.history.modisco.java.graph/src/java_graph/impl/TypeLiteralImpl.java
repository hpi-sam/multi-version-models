 ...
 * </p>
 * <ul>
 *   <li>{@link java_graph.impl.TypeLiteralImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TypeLiteralImpl extends ExpressionImpl implements TypeLiteral {
	...
	protected EClass eStaticClass() {
		return Java_graphPackage.eINSTANCE.getTypeLiteral();
	}
	...
	public EList<TypeAccess> getType() {
		if (type == null) {
			type = new EObjectResolvingEList<TypeAccess>(TypeAccess.class, this, Java_graphPackage.TYPE_LITERAL__TYPE);
		}
		return type;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Java_graphPackage.TYPE_LITERAL__TYPE:
				return getType();
		}
