 ...
 * </p>
 * <ul>
 *   <li>{@link java_graph.impl.SynchronizedStatementImpl#getBody <em>Body</em>}</li>
 *   <li>{@link java_graph.impl.SynchronizedStatementImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SynchronizedStatementImpl extends StatementImpl implements SynchronizedStatement {
	...
	protected EClass eStaticClass() {
		return Java_graphPackage.eINSTANCE.getSynchronizedStatement();
	}
	...
	public EList<Block> getBody() {
		if (body == null) {
			body = new EObjectResolvingEList<Block>(Block.class, this, Java_graphPackage.SYNCHRONIZED_STATEMENT__BODY);
		}
		return body;
	}
	...
	public EList<Expression> getExpression() {
		if (expression == null) {
			expression = new EObjectResolvingEList<Expression>(Expression.class, this, Java_graphPackage.SYNCHRONIZED_STATEMENT__EXPRESSION);
		}
		return expression;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Java_graphPackage.SYNCHRONIZED_STATEMENT__BODY:
				return getBody();
			case Java_graphPackage.SYNCHRONIZED_STATEMENT__EXPRESSION:
