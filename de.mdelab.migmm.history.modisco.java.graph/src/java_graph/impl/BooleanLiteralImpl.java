 ...
 * </p>
 * <ul>
 *   <li>{@link java_graph.impl.BooleanLiteralImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BooleanLiteralImpl extends ExpressionImpl implements BooleanLiteral {
	...
	protected EClass eStaticClass() {
		return Java_graphPackage.eINSTANCE.getBooleanLiteral();
	}
	...
	public EList<Boolean> getValue() {
		if (value == null) {
			value = new EDataTypeEList<Boolean>(Boolean.class, this, Java_graphPackage.BOOLEAN_LITERAL__VALUE);
		}
		return value;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Java_graphPackage.BOOLEAN_LITERAL__VALUE:
				return getValue();
		}
