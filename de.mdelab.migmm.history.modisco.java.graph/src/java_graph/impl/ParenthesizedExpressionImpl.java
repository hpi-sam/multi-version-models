 ...
 * </p>
 * <ul>
 *   <li>{@link java_graph.impl.ParenthesizedExpressionImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParenthesizedExpressionImpl extends ExpressionImpl implements ParenthesizedExpression {
	...
	protected EClass eStaticClass() {
		return Java_graphPackage.eINSTANCE.getParenthesizedExpression();
	}
	...
	public EList<Expression> getExpression() {
		if (expression == null) {
			expression = new EObjectResolvingEList<Expression>(Expression.class, this, Java_graphPackage.PARENTHESIZED_EXPRESSION__EXPRESSION);
		}
		return expression;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Java_graphPackage.PARENTHESIZED_EXPRESSION__EXPRESSION:
