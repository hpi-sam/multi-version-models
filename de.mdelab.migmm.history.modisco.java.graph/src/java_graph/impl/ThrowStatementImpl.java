 ...
 * </p>
 * <ul>
 *   <li>{@link java_graph.impl.ThrowStatementImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ThrowStatementImpl extends StatementImpl implements ThrowStatement {
	...
	protected EClass eStaticClass() {
		return Java_graphPackage.eINSTANCE.getThrowStatement();
	}
	...
	public EList<Expression> getExpression() {
		if (expression == null) {
			expression = new EObjectResolvingEList<Expression>(Expression.class, this, Java_graphPackage.THROW_STATEMENT__EXPRESSION);
		}
		return expression;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Java_graphPackage.THROW_STATEMENT__EXPRESSION:
