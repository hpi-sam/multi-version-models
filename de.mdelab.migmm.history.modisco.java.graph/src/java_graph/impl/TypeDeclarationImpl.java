 ...
 * </p>
 * <ul>
 *   <li>{@link java_graph.impl.TypeDeclarationImpl#getTypeParameters <em>Type Parameters</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class TypeDeclarationImpl extends AbstractTypeDeclarationImpl implements TypeDeclaration {
	...
	protected EClass eStaticClass() {
		return Java_graphPackage.eINSTANCE.getTypeDeclaration();
	}
	...
	public EList<TypeParameter> getTypeParameters() {
		if (typeParameters == null) {
			typeParameters = new EObjectResolvingEList<TypeParameter>(TypeParameter.class, this, Java_graphPackage.TYPE_DECLARATION__TYPE_PARAMETERS);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Java_graphPackage.TYPE_DECLARATION__TYPE_PARAMETERS:
