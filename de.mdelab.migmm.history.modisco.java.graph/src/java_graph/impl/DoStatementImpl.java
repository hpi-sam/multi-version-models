 ...
 * </p>
 * <ul>
 *   <li>{@link java_graph.impl.DoStatementImpl#getExpression <em>Expression</em>}</li>
 *   <li>{@link java_graph.impl.DoStatementImpl#getBody <em>Body</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DoStatementImpl extends StatementImpl implements DoStatement {
	...
	protected EClass eStaticClass() {
		return Java_graphPackage.eINSTANCE.getDoStatement();
	}
	...
	public EList<Expression> getExpression() {
		if (expression == null) {
			expression = new EObjectResolvingEList<Expression>(Expression.class, this, Java_graphPackage.DO_STATEMENT__EXPRESSION);
		}
		return expression;
	}
	...
	public EList<Statement> getBody() {
		if (body == null) {
			body = new EObjectResolvingEList<Statement>(Statement.class, this, Java_graphPackage.DO_STATEMENT__BODY);
		}
		return body;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Java_graphPackage.DO_STATEMENT__EXPRESSION:
				return getExpression();
			case Java_graphPackage.DO_STATEMENT__BODY:
				return getBody();
		}
