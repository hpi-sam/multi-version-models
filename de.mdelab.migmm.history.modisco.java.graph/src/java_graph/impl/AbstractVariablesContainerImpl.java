 ...
 * </p>
 * <ul>
 *   <li>{@link java_graph.impl.AbstractVariablesContainerImpl#getType <em>Type</em>}</li>
 *   <li>{@link java_graph.impl.AbstractVariablesContainerImpl#getFragments <em>Fragments</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class AbstractVariablesContainerImpl extends ASTNodeImpl implements AbstractVariablesContainer {
	...
	protected EClass eStaticClass() {
		return Java_graphPackage.eINSTANCE.getAbstractVariablesContainer();
	}
	...
	public EList<TypeAccess> getType() {
		if (type == null) {
			type = new EObjectResolvingEList<TypeAccess>(TypeAccess.class, this, Java_graphPackage.ABSTRACT_VARIABLES_CONTAINER__TYPE);
		}
		return type;
	}
	...
	public EList<VariableDeclarationFragment> getFragments() {
		if (fragments == null) {
			fragments = new EObjectWithInverseResolvingEList.ManyInverse<VariableDeclarationFragment>(VariableDeclarationFragment.class, this, Java_graphPackage.ABSTRACT_VARIABLES_CONTAINER__FRAGMENTS, Java_graphPackage.VARIABLE_DECLARATION_FRAGMENT__VARIABLES_CONTAINER);
		}
		return fragments;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Java_graphPackage.ABSTRACT_VARIABLES_CONTAINER__FRAGMENTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Java_graphPackage.ABSTRACT_VARIABLES_CONTAINER__TYPE:
				return getType();
			case Java_graphPackage.ABSTRACT_VARIABLES_CONTAINER__FRAGMENTS:
				return getFragments();
		}
